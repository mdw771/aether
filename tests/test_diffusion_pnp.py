...
class TestDiffusionPnP(tutils.TungstenDataTester):
    ...
    @tutils.TungstenDataTester.wrap_recon_tester(name="diffusion_pnp")
    def test_diffusion_pnp(self):
        ...
        options = api.AlternatingProjectionOptions()
        ...
        options.reconstructor_options.num_inference_steps = 20
        options.reconstructor_options.editing_prompt = "dot grid"
        options.reconstructor_options.remove_concept = True
        options.reconstructor_options.text_guidance_scale = 7
        options.reconstructor_options.num_data_projection_epochs = 20
